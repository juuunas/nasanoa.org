...
<div class="*:transition-all *:duration-500 flex gap-16 flex-col items-center justify-center min-h-screen">
  <Image
    class="peer invert hover:invert-0 -rotate-6 scale-90 hover:rotate-1 hover:scale-100"
    src={hkmoriPfp}
    alt="hkmori's SoundCloud pfp"
  />
  <h1 class="peer-hover:invert rounded-lg bg-black text-white tracking-tighter peer-hover:tracking-widest w-full text-center p-1">
    hkmori
  </h1>
</div>
...
- 03.09.2024: hkmori actually started making music on April 2022, not on July 2022
